...
def index():
    if request.method == 'POST':
        ...
        prompt=f"{session['name']}1人分の材料と分量(kg)をcsvで出力してください.ヘッダーは省略します.数値は小数で出力します.1列目に材料を,2列目に分量を記述します.ただし,分量は,単位を省略してください.なお,材料に肉が含まれる場合,牛肉,豚肉,合挽肉,鶏肉の4種類の中から1種類を選択し,使用するものとします.ただし,肉以外の材料は,すべてカタカナ表記してください."
